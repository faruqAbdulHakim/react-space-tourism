    ...
    <div className="flex flex-col desktop:flex-row justify-between mx-6 tablet:mx-40">
      <div className="order-2 tablet:order-1 self-center mt-8 tablet:mt-14 desktop:mt-0 text-center desktop:text-left flex flex-col gap-8 tablet:gap-10 desktop:gap-32 pb-20 tablet:pb-0">
        <div className="order-2 tablet:order-1">
          <p className="text-white/50 text-tiny tablet:text-lg desktop:text-xl font-serif uppercase">
            {crews[slide].position}
          </p>
          <h2 className="mt-2 desktop:mt-4 text-lg tablet:text-[40px] desktop:text-2xl font-serif uppercase">
            {crews[slide].name}
          </h2>
          <p className="text-icy-plains mt-4 desktop:mt-6 text-tiny desktop:text-base max-w-[444px]">
            {crews[slide].text}
          </p>
        </div>
